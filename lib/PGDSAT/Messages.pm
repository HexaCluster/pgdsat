...
%AUDIT_MSG = (
	'en_US' => {
		...
		'2.5' => { 'errmsg' => 'Permission on the Unix socket should be more restrictive, for example: 0770 or 0700. Currently it is set to 0777.' },
		...
		'6.11' => { 'errmsg' => 'Extension pgcrypto or pgsodium are not installed.' },
...
#-----------------------------------------------------------------------------
		...
		'2.5' => { 'errmsg' => 'Les autorisations de la socket Unix devraient être plus restrictives, par exemple: 0770 ou 0700. Actuellement elles ont positionnées à 0777.' },
