...
%AUDIT_MSG = (
	'en_US' => {
		...
		'2.9' => { 'errmsg' => 'Failed to get shared directory using %s. Error code %s.' },
		'2.10' => { 'errmsg' => 'Failed to get permission on the extensions directory %s. Error code %s.' },
...
#-----------------------------------------------------------------------------
		...
		'2.9' => { 'errmsg' => 'Impossible d\'obtenir le répertoire partagé avec %s. Code d\'erreur %s.' },
		'2.10' => { 'errmsg' => 'Impossible d\'obtenir l\'autorisation sur le répertoire des extensions %s. Code d\'erreur %s.' },
		...
		'5.17' => { 'errmsg' => 'le paramètre \'password_encryption\' devrait être positionné à la valeur \'scram-sha-256\', et non \'%s\'.' },
		'5.18' => { 'errmsg' => 'Certains processus utilisent un mot de passe dans la chiane de connection à PostgreSQL.' },
		'5.19' => { 'errmsg' => 'la valeur du paramètre "listen_addresses" est trop permissive.' },
		'5.20' => { 'errmsg' => 'Certains utilisateur n\'ont pas de limite de connection.' },
...
#-----------------------------------------------------------------------------
		...
		'2.9' => { 'errmsg' => '使用 %s 获取共享目录失败。错误代码 %s' },
		'2.10' => { 'errmsg' => '获取扩展目录 %s 的权限失败。错误代码 %s。' },
		...
		'5.18' => { 'errmsg' => '某些进程会在 PostgreSQL 连接字符串中使用密码。' },
		'5.19' => { 'errmsg' => '“listen_addresses”设置的值过于宽松。' },
		'5.20' => { 'errmsg' => '部分用户没有连接数限制。' },
